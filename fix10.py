...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token='EtiMVd7PfLa1xqNvtp1d.EPUpmSg1XRydYA6eKlGV3q.BscU0btExIeUxzxNGmbbWdtfdvP+TyOdLoBPEQmEJTY=')
cl.loginResult()
...
kk = LINETCR.LINE()
#kk.login(qr=True)
kk.login(token='Et7lcGC20ujUxzm9W5f2.EbY89eg/+GSkNmqfiUOP0G.c5oCJeJkPe5A395/GTcDHLj7t5uWD3Ewp+h82RrOLN8=')
kk.loginResult()
print "Kk-Login Success\n"

kc = LINETCR.LINE()
#kc.login(qr=True)
kc.login(token='EtU1NewRhcAxB7MSoUP4.Rnpmy9t67j94Wrm8Nz53ra.54vvnqgnpdYjvculbG367I6FgnsC1TIg1Hqj9YM2GvQ=')
kc.loginResult()
print "Kc-Login Success\n"

kr = LINETCR.LINE()
#kr.login(qr=True)
kr.login(token='EtRxnZ46OZGFwoCPReKd.lngcFaxktL5ic+wKEiNz3q.z9FI3TehXlytZlaT/RFWUg7+rI7ISiNx8guJ79ExyPg=')
kr.loginResult()
print "Kr-Login Success\n"

kd = LINETCR.LINE()
#kd.login(qr=True)
kd.login(token='EtMhzBfbosCtFbNtR5Vb.xsP1hWhUuMNvvcRN6inH6W.p7y2xL/qZH+Qfwg4oc8EjWoNIUe94AHSUsSlJZnrccM=')
kd.loginResult()
print "kd-Login Success\n"

ks = LINETCR.LINE()
#ks.login(qr=True)
ks.login(token='EtViu6pIp35AgMRpjAYe.AN8Rf8EddP5DQL3ruhYRZG.ywUugWu3rrdp61JQXjmNK0YO82ZGW4XdirQQI0ZHojE=')
ks.loginResult()
print "ks-Login Success\n"

kz = LINETCR.LINE()
#kz.login(qr=True)
kz.login(token='EtRroJfoL9S0A6TCzdYd.q9eWE1cdZrBUtMWtY8q2dq.W/n0BjPdZZ+M0ZuZ4o7AsPOw6PMkNoM9q9v2hGOfoOU=')
kz.loginResult()
print "kz-Login Success\n"

kx = LINETCR.LINE()
#kx.login(qr=True)
kx.login(token='Etkte54oloYxBh7VPZa8.CnKKFvD8fvC/0bCDlj472a.Kn4Yp5ETAsnCIGVNjmPy2+qREwU0IzNm5A2DCuPVDSE=')
kx.loginResult()
print "kx-Login Success\n"

km = LINETCR.LINE()
#km.login(qr=True)
km.login(token='EtYDjujVFBMkSR5AKRW9.DJ4XOyfGYw4gTzYh1DOEUq.SXlstz40vNCAW0ZwiO000zvsMd2vTabXKUEahFNJcfA=')
km.loginResult()
...
╚═════════════════════════
"""
tjia="u1f39bdcc5834e3993d1c159f0066a491"
...
KAC=[cl,ki,kk,kc,kr,kd,ks,kz,kx]
...
Gmid = ks.getProfile().mid
Hmid = kz.getProfile().mid
Imid = kx.getProfile().mid
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid]
Creator=["ucc45939cb6bf397646478401404e52f5"]
admin=["ucc45939cb6bf397646478401404e52f5","ua4ff2bbbf563807cb29ac18c2a2317a8","u01495edb9bba264ac6fde3aab4c8d241","uc3d7eafac51fd9e46e2bb5c70363337d","uaf159a314d2a1ae38e762faf22ecf30e"]
...
responsename7 = ks.getProfile().displayName
responsename8 = kz.getProfile().displayName
responsename9 = kx.getProfile().displayName
...
wait = {
    ...
    "comment4":"Nice Kak (^_^)",
    "comment5":"Bot Auto Like ©By : RoyDenS\nContact Me : 👉 line.me/ti/p/~roy_dens.",    
    "commentOn":True,
    "commentBlack":{},
    ...
    try:
                ...
                try:
                    if cctv['cyduk'][op.param1]==True:
                        if op.param1 in cctv['point']:
                            ...
                            Name = kd.getContact(op.param2).displayName
                            Name = ks.getContact(op.param2).displayName
                            Name = kz.getContact(op.param2).displayName
                            Name = kx.getContact(op.param2).displayName
	 ...
	 if wait["Ghost"] == True:
		...
		cl.sendText(msg.to,"Itu Majikan Kami (^_^)")
                ...
                msg.contentType = 13
                admin1 = "uaf159a314d2a1ae38e762faf22ecf30e"
		...
		cl.sendText(msg.to,"Itu Yang Buat Grup Ini")
            ...
            if msg.contentType == 13:
                if wait['invite'] == True:
                     ...
                     groups = kz.getGroup(msg.to)                     
                     groups = kx.getGroup(msg.to)
                     pending = groups.invitee
                     targets = []
                     for s in groups.members:
                         if _name in s.displayName:
                     ...
                     if targets == []:
                         ...
                         for target in targets:
                             try:
                                 ...
                                 kz.findAndAddContactsByMid(target)                                 
                                 kx.findAndAddContactsByMid(target) 
		...
		if msg.from_ in admin:                cl.sendText(msg.to,creatorMessage)

            elif msg.text in ["Key group","help group","Help group"]:
		if msg.from_ in admin:                cl.sendText(msg.to,groupMessage)

            elif msg.text in ["Key","help","Help"]:
		if msg.from_ in admin:                cl.sendText(msg.to,helpMessage)

            elif msg.text in ["Key self","help self","Help self"]:
		if msg.from_ in admin:               cl.sendText(msg.to,selfMessage)

            elif msg.text in ["Key bot","help bot","Help bot"]:
		if msg.from_ in admin:                cl.sendText(msg.to,botMessage)

            elif msg.text in ["Key set","help set","Help set"]:
		if msg.from_ in admin:                cl.sendText(msg.to,setMessage)

            elif msg.text in ["Key media","help media","Help media"]:
		if msg.from_ in admin:               cl.sendText(msg.to,mediaMessage)
                
            elif msg.text in ["Key admin","help admin","Help admin"]:
		if msg.from_ in admin:                cl.sendText(msg.to,adminMessage)    
                
            elif msg.text in ["Key protect","help protect","Help protect"]:
		if msg.from_ in admin:               cl.sendText(msg.to,protectMessage)                 
		...
		if msg.from_ in admin:
		    ...
		    cl.sendText(msg.to, "Khusus RoyDenS")
		...
		try:
		    if msg.from_ in Creator:
                        for i in gid:
                            ...
                            h = kz.getGroup(i).name
                            h = kx.getGroup(i).name
		            if h == ng:
		...
		if msg.from_ in admin:
                    ...
                    wait["Qron"] = True
                    wait["Ghost"] = True     
                    cl.sendText(msg.to,"Seluruh Keamanan Sudah Aktif")
		    print wait["AutoCancel"]
		    print wait["AutoKick"]
		    print wait["Qr"]
		else:
		...
		if msg.from_ in admin:
                    ...
                    wait["Qron"] = False
                    wait["Ghost"] = False 
                    cl.sendText(msg.to,"Seluruh Keamanan Sudah Di Nonaktifkan")
		    print wait["AutoCancel"]
		    print wait["AutoKick"]
		    print wait["Qr"]
#		else:                    
		    ...
		    cl.sendText(msg.to,"Khusus RoyDenS")
                ...
                if wait["Sambutan"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Sambutan Di Aktifkan Roy")
                else:
                    wait["Sambutan"] = True
                    wait["joinkick"] = False
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Sudah On Kang")

            elif msg.text in ["Sambutan off"]:
                if wait["Sambutan"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Sambutan Di Nonaktifkan Roy")
                else:
                    wait["Sambutan"] = False
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Sudah Off Kang")
                        
                        
            elif msg.text in ["Kepo on"]:
                if msg.from_ in admin:
                    try:
                    ...
                    wait["Kepo"] = True
                    cl.sendText(msg.to,"Siap On Cek Kepo")
                else:
                    cl.sendText(msg.to,"Khusus RoyDenS")
                
            elif msg.text in ["Kepo off"]:
                if msg.from_ in admin:
                    if msg.to in cctv['point']:
                        cctv['cyduk'][msg.to]=False
                        wait["Kepo"] = False
                        cl.sendText(msg.to, "Cek Kepo Off")
                    else:
                        cl.sendText(msg.to,"Khusus RoyDenS")
		...
		if wait["Kepo"] == True: md+="╠➩✔️ Auto Kepo : On\n"
		else:md+="╠➩❌ Auto Kepo: Off\n"	
		if wait["Simi"] == True: md+="╠➩✔️ Simisimi : On\n"
            ...
            elif msg.text in ["RoyDenS1 Gift","RoyDenS1 gift"]:
                msg.contentType = 9
            ...
            elif msg.text in ["RoyDenS2 Gift","RoyDenS2 gift"]:
                msg.contentType = 9
            ...
            elif msg.text in ["RoyDenS3 Gift","RoyDenS3 gift"]:
                msg.contentType = 9
	    ...
	    elif msg.text in ["Cipok","Sepi Woy"]:
	     if msg.from_ in admin:
		...
		if midd not in admin:
		    ...
		    cl.sendText(msg.to,"Admin Detected")
                ...
                kx.findAndAddContactsByMid(midd)
                random.choice(KAC).inviteIntoGroup(msg.to,[midd])

            elif "Invite creator" in msg.text:
                midd = "ucc45939cb6bf397646478401404e52f5"
                random.choice(KAC).inviteIntoGroup(msg.to,[midd])
		...
		if msg.from_ in admin:
            ...
            elif msg.text in ["RoyDenS1 join"]:
		if msg.from_ in admin:
                    X = cl.getGroup(msg.to)
                    X.preventJoinByTicket = False
                    cl.updateGroup(X)
            ...
            elif msg.text in ["RoyDenS2 join"]:
		if msg.from_ in admin:
                    X = cl.getGroup(msg.to)
                    X.preventJoinByTicket = False
                    cl.updateGroup(X)
            ...
            elif msg.text in ["RoyDenS3 join"]:
		if msg.from_ in admin:
                    G = cl.getGroup(msg.to)
                    ginfo = cl.getGroup(msg.to)
                    G.preventJoinByTicket = False
            ...
            elif msg.text in ["RoyDenS4 join"]:
		if msg.from_ in admin:
                    G = cl.getGroup(msg.to)
                    ginfo = cl.getGroup(msg.to)
                    G.preventJoinByTicket = False
		...
		cl.sendText(msg.to,"Pasukan Absen!!")
                ki.sendText(msg.to,"RoyDenS1 Hadiir  Boss")
                kk.sendText(msg.to,"RoyDenS2 Hadiir  Boss")
                kc.sendText(msg.to,"RoyDenS3 Hadiir  Boss")
                kr.sendText(msg.to,"RoyDenS4 Hadiir  Boss")
                kd.sendText(msg.to,"RoyDenS5 Hadiir  Boss")
                ks.sendText(msg.to,"RoyDenS6 Hadiir  Boss")
                kz.sendText(msg.to,"RoyDenS7 Hadiir  Boss")
                kx.sendText(msg.to,"Hadiir Semua Kapten  Roy")
		...
		cl.sendText(msg.to,responsename)
                ...
                kd.sendText(msg.to,responsename6)
                ks.sendText(msg.to,responsename7)
                kz.sendText(msg.to,responsename8)
                kx.sendText(msg.to,responsename9)
		...
		if msg.from_ in Creator:
		    ...
		    cl.sendText(msg.to,"Lu sape!")
              ...
              if msg.from_ in admin:
                ...
                if msg.from_ in admin:
                    wait["blacklist"] = {}
                    cl.sendText(msg.to,"Boss└ ❉Unbanned All Success❉ ┐") 

            elif msg.text.lower() in ["bot","roy"]:
                cl.sendText(msg.to,"Apa Manggil~Manggil Aku!?") 
                cl.sendText(msg.to,"☆Kangen Ya Kamu ??☆") 
		...
		if msg.from_ in Creator:
	        ...
	        if msg.from_ in Creator:                
              ...
              if msg.from_ in Creator:
                msg.contentType = 13
                msg.contentMetadata = {'mid': "RoyDenS,'"}
                cl.sendMessage(msg)
            ...
            elif "RoyDenS1 copy @" in msg.text:
                   print "[COPY] Ok"
                   _name = msg.text.replace("RoyDenS1 copy @","")
                   _nametarget = _name.rstrip('  ')
                   gs = ki.getGroup(msg.to)
                   targets = []
                   for g in gs.members:
                       ...
                       for target in targets:
                            try:
                               ...
                               ki.sendText(msg.to, "Copied (^_^)")
                                ...
                                print e
            elif "RoyDenS2 copy @" in msg.text:
                   print "[COPY] Ok"
                   _name = msg.text.replace("RoyDenS2 copy @","")
                   _nametarget = _name.rstrip('  ')
                   gs = kk.getGroup(msg.to)
                   targets = []
                   for g in gs.members:
            ...
            elif "RoyDenS3 copy @" in msg.text:
                   print "[COPY] Ok"
                   _name = msg.text.replace("RoyDenS3 copy @","")
                   _nametarget = _name.rstrip('  ')
                   gs = kc.getGroup(msg.to)
                   targets = []
                   for g in gs.members:
            ...
            elif "RoyDenS4 copy @" in msg.text:
                   print "[COPY] Ok"
                   _name = msg.text.replace("RoyDenS4 copy @","")
                   _nametarget = _name.rstrip('  ')
                   gs = kr.getGroup(msg.to)
                   targets = []
                   for g in gs.members:
                ...
                try:
                    ...
                    kd.updateDisplayPicture(backup6.pictureStatus)
                    kd.updateProfile(backup6)
                    
                    ks.updateDisplayPicture(backup7.pictureStatus)
                    ks.updateProfile(backup8)
                    
                    kz.updateDisplayPicture(backup8.pictureStatus)
                    kz.updateProfile(backup8)
                    
                    kx.updateDisplayPicture(backup9.pictureStatus)
                    kx.updateProfile(backup9)
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                link = ["http://dl.profile.line-cdn.net/0hqrZyrFUULl1nAAMaXtVRCltFIDAQLj8VCTFhPxJScmRPMW0NXmZpa0MFcm9NNTxeCG4xPEsHcGVM"]
                                pilih = random.choice(link)
                                cl.sendImageWithURL(msg.to,pilih)

 
            elif "Sukurin: " in msg.text:
                  bctxt = msg.text.replace("Sukurin: ", "")
                  t = 10
                  while(t):
		...
		if msg.from_ in Creator:
              ...
              if msg.from_ in admin:
                ...
                cl.sendText(msg.to,"Stop Stop Stop..... Kabooooorrrrrr")
            ...
            elif "bersihkan" in msg.text.lower():
                if msg.from_ in admin:
                    try:
                ...
                if msg.from_ in admin:
                    ...
                    if gid == "":
                        ...
                        try:
                            ...
                            kz.findAndAddContactsByMid(msg.from_)
                            kx.findAndAddContactsByMid(msg.from_)
