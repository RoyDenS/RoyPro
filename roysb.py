...
nadya = LINETCR.LINE()
#nadya.login(qr=True)
nadya.login(token='EtF6UMmheRrJAQhO9uW5.ZewtNlA+oxzgr4qbqe5s9q.wPG4qB3iYbC6mW36GSv4YiMuUBtJa1ADWsb9lmvPZi0=')
nadya.loginResult()
...
╚═════════════════════════
"""
tjia="ucc45939cb6bf397646478401404e52f5"
...
admin=["ucc45939cb6bf397646478401404e52f5"]
...
wait = {
    ...
    'timeline':True,
    "Timeline":True,
    "comment":"Bot Auto Like ©By : RoyDenS\nContact Me : 👉 line.me/ti/p/~roy_dens.",    
    "commentOn":True,
    "commentBlack":{},
...
#                            Name = summon(op.param2)
		...
		if msg.from_ in admin:
		    ...
		    nadya.sendText(msg.to,"Khusus Nadya")
            ...
            elif msg.text in ["Salam on"]:
                if wait["Salam"] == True:
                    if wait["lang"] == "JP":
                        nadya.sendText(msg.to,"Salam Di Aktifkanヾ(*´∀｀*)ﾉ")
                else:
                    wait["Salam"] = True
                    if wait["lang"] == "JP":
                        nadya.sendText(msg.to,"Sudah Onヽ(´▽｀)/")

            elif msg.text in ["Salam off"]:
                if wait["Salam"] == False:
                    if wait["lang"] == "JP":
                        nadya.sendText(msg.to,"Salam Di Nonaktifkan(　＾∇＾)")
                else:
                    wait["Salam"] = False
                    if wait["lang"] == "JP":
                ...
                md = ""
		if wait["Salam"] == True: md+="╠➩✔️ Salam : On\n"
		else:md+="╠➩❌ Salam : Off\n"
		...
		if wait["Tendang"] == True: md+="╠➩✔️ Auto Kick : On\n"
